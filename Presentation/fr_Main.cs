...
namespace QuanLyCafe.Presentation
{
    public partial class fr_Main : Form
    {
        ...
        private void banCafeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            fm_quanlyban fm = new fm_quanlyban();
            fm.ShowDialog();
        }

        private void billBanCafeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            fmBill fm = new fmBill();
            fm.ShowDialog();
        }
    }
}
